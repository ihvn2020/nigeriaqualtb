                    ...
                    <form method="POST" action="{{ route('newareport') }}">                        
                        ...
                        <div class="row form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="Name this report" required>  

                            </div>
                            <div class="form-group col-md-2">
                                <label for="from">From (Date)</label>
                                <input type="text" name="from" id="from" class="form-control" placeholder="Begin" required>                                  
                            </div>
                            <div class="form-group col-md-2">
                                <label for="to">To (Date)</label>
                                <input type="text" name="to" id="to" class="form-control" placeholder="End" required>                                  
                            </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">                                            
                                            <input type="number" name="ndstb1u15" id="ndstb1u15" placeholder="0-14yrs" class="form-control tooltipped" data-toggle="tooltip" data-placement="top" title="Total # of 0-14yrs">
                                        </div>
                                        <div class="col-xs-3">
                                            <input type="number" name="ndstb1a15" id="ndstb1a15" placeholder="15+yrs" class="form-control tooltipped" data-toggle="tooltip" data-placement="top" title="Total # of 15yrs and above">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb1" id="ddstb1" placeholder="Total" class="form-control">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ndstb2u15" id="ndstb2u15" placeholder="0-14yrs"  class="form-control tooltipped" data-toggle="tooltip" data-placement="top" title="Total # of 0-14yrs">
                                        </div>
                                        <div class="col-xs-3">
                                            <input type="number" name="ndstb2a15" id="ndstb2a15" placeholder="15+yrs"  class="form-control tooltipped" data-toggle="tooltip" data-placement="top" title="Total # of 15yrs and above">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb2" id="ddstb2" placeholder="Total" class="form-control">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb3" id="ddstb3" class="form-control" onChange="compareDeno(3) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb4" id="ddstb4" class="form-control" onChange="compareDeno(4) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb5" id="ddstb5" class="form-control" onChange="compareDeno(5) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb6" id="ddstb6" class="form-control" onChange="compareDeno(6) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb7" id="ddstb7" class="form-control" onChange="compareDeno(7) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb8" id="ddstb8" class="form-control" onChange="compareDeno(8) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb9" id="ddstb9" class="form-control" onChange="compareDeno(9) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb10" id="ddstb10" class="form-control" onChange="compareDeno(10) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb11" id="ddstb11" class="form-control" onChange="compareDeno(11) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb12" id="ddstb12" class="form-control" onChange="compareDeno(12) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb13" id="ddstb13" class="form-control" onChange="compareDeno(13) ">
                                        </div>
                                            ...
                                            <input type="hidden" name="ddstb14" id="ddstb14" class="form-control" onChange="compareDeno(14) ">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb15" id="ddstb15" class="form-control" onChange="compareDeno(15) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb16" id="ddstb16" class="form-control" onChange="compareDeno(16) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb17" id="ddstb17" class="form-control" onChange="compareDeno(17) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb18" id="ddstb18" class="form-control" onChange="compareDeno(18) ">
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-xs-3">
                                            <input type="number" name="ddstb19" id="ddstb19" class="form-control" onChange="compareDeno(19)">
                                        </div>
