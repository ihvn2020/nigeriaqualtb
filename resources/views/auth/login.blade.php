...
@section('content')
    <div class="header">
        <div class="logo text-center"><img src="{{ asset('/images/' . $settings->logo) }}" alt="Logo" height="30"
                width="auto"></div>
    ...
    <form method="POST" action="{{ route('login') }}" class="form-auth-small">
        ...
        <div class="form-group clearfix">
            <label class="fancy-checkbox element-left" for="remember">
                <input class="fancy-checkbox element-left" type="checkbox" name="remember" id="remember"
